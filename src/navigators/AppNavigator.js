...
export const MainScreen = TabNavigator({
  Explore: {
    ...
    navigationOptions: {
      tabBarLabel: 'EXPLORE',
      tabBarIcon: ({focused, tintColor}) => <Icon name={'ionicons ion-android-menu'} size={30} color={tintColor}/>
    }
  },
  Profile: {
    screen: ProfileTab,
    navigationOptions: {
      tabBarLabel: 'PROFILE',
      tabBarIcon: ({focused, tintColor}) => <Icon name={'social-android'} size={30} color={tintColor}/>
    }
  },
}, tabConfig);
