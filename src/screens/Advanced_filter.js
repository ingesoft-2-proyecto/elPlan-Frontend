...
class Home extends Component {
  ...
  componentDidMount(){
    console.log("advanced_filter in screens, componentWillMount()");
    this.props.getSearchEvents();
  }

  constructor(props) {
    super(props);
    console.log("advanced_filter.js in screens, constructor");
    this.state = {
      isLoading: false,
      name: '',
      source: { uri: ''},
  ...
  searchPrice(search){
    window.events = "statistic_cost";
    window.eventsPrice = search;
    Actions.home()
  }

  searchCategori(search){
    window.events = "event_filter";
    window.eventsCategory = search;
    Actions.home()
  }

  advanced_filter() {
    console.log("advanced_filter in screens, advanced_filter()");
    Actions.advanced_filter()
  }

  events() {
    console.log("advanced_filter in screens, events()");
    Actions.events()
  }

  home(){
    window.events = "events";
    console.log("advanced_filter in screens, home()");
    Actions.home()
  }

  menu() {
    console.log("advanced_filter in screens, menu()");
    Actions.menu()
  }

  profile() {
    console.log("advanced_filter in screens, profile()");
    Actions.profile()
  }
  ...
  async GetInfo() {
    console.log("advanced_filter in screens, GetInfo()");
    this.setState(
      {
        isLoading: true
      }
  ...
  render() {
    console.log("advanced_filter in screens, render()");
      return (
        <View style={styles.container}>
          ...
          <View style={styles.container3}>
            <TextInput style={styles.searchBox}
              ...
              placeholder={"Put the maximum price or \r\n the category of the event!"}
              maxLength={100}
            ...
            <TouchableOpacity style={styles.buttonFilters}
              onPress={() => this.searchPrice(this.state.search)}>
              <Text style={styles.buttonText}>Search event by price</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonFilters}
              onPress={() => this.searchCategori(this.state.search)}>
              <Text style={styles.buttonText}>Search event by category</Text>
            </TouchableOpacity>
          </View>
          <View>
